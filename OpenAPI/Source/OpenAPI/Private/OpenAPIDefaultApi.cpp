...
FHttpRequestPtr OpenAPIDefaultApi::MmologinMmologinPost(const MmologinMmologinPostRequest& Request, const FMmologinMmologinPostDelegate& Delegate /*= FMmologinMmologinPostDelegate()*/) const
{
	if (!IsValid())
		return nullptr;
	...
	HttpRequest->OnProcessRequestComplete().BindRaw(this, &OpenAPIDefaultApi::OnMmologinMmologinPostResponse, Delegate);
	HttpRequest->ProcessRequest();
	return HttpRequest;
}

void OpenAPIDefaultApi::OnMmologinMmologinPostResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FMmologinMmologinPostDelegate Delegate) const
{
	MmologinMmologinPostResponse Response;
